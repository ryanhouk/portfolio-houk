        ...
        <div className='max-w-7xl mx-auto'>
          <div className='max-w-2xl'>
            ...
            <FadeY once delay={.25} className='mt-12'>
              ...
              <p className='font-mono text-white lg:text-xs leading-loose'>
            ...
            <FadeY once delay={.5} className='mt-8'>
              ...
              <p className='font-mono text-white lg:text-xs leading-loose'>I addressed the issue of scattered links and files by launching a website leveraging Azure, making it easy to digest the developer state of tasks in flight. Additionally, I integrated a feature allowing customers to find their platform, view its uptime, and see mockups. This move not only made it easier for everyone to find what they needed but also enhanced transparency and trust by providing real-time insights into platform performance. It sped up collaboration and cut down on the frustration of digging through emails and Teams messages, making our work smoother and more productive.</p>
            </FadeY>
          </div>
        </div>
      </section>
