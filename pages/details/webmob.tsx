...
import DoodleLoops from '../../components/svg/DoodleLoops';
...
const WebMob = (props: Props) => {
  return (
    <>
      {/* HEADER */}
      <PageHeader title={'Web & Mobile'} backgroundImage={'/img/mockup/internal.webp'} />

      <section className='pt-8 lg:pt-32 px-8'>
        <div className='max-w-7xl mx-auto'>
          <div className='max-w-2xl'>
            <FadeY once className='border-y border-white/20 py-12'>
              <h2 className='text-white/60 font-object leading-relaxed text-xl lg:text-2xl'>
            ...
            <FadeY once delay={.25} className='mt-12'>
              ...
              <p className='font-mono text-white text-xs leading-loose'>
            ...
            <FadeY once delay={.5} className='mt-8'>
              ...
              <p className='font-mono text-white text-xs leading-loose'>I addressed the issue of scattered links and files by launching a website leveraging Azure, making it easy to digest the developer state of tasks in flight. Additionally, I integrated a feature allowing customers to find their platform, view its uptime, and see mockups. This move not only made it easier for everyone to find what they needed but also enhanced transparency and trust by providing real-time insights into platform performance. It sped up collaboration and cut down on the frustration of digging through emails and Teams messages, making our work smoother and more productive.</p>
            </FadeY>
          </div>
        </div>
      </section>
      ...
      <section className='my-16 lg:my-32 max-w-screen-2xl mx-auto'>
        <FadeY once className='grid grid-cols-2 gap-8'>
          <div className='col-span-1 relative'>
            <p className='bg-black m-4 text-white absolute left-0 bottom-0 z-10 p-2 font-mono text-sm'>View designed so internal customers can quickly get to where they need.</p>
            <Image src={`/img/details/webmob/wm-home.jpg`} alt={`screenshot of internal site`} height={2280} width={3480} className='w-full' />
          </div>
          <div className='col-span-1 relative'>
            <p className='bg-black m-4 text-white absolute left-0 bottom-0 z-10 p-2 font-mono text-sm'>Platforms showcases all internal products for stakeholders to dive into.</p>
            <Image src={`/img/details/webmob/wm-platforms.jpg`} alt={`screenshot of internal site`} height={2280} width={3480} className='w-full' />
          </div>
          <div className='col-span-1 relative'>
            <p className='bg-black m-4 text-white absolute left-0 bottom-0 z-10 p-2 font-mono text-sm'>New employees can better on board and understand application requirements.</p>
            <Image src={`/img/details/webmob/wm-promo-02.jpg`} alt={`screenshot of internal site`} height={2280} width={3480} className='w-full' />
          </div>
          <div className='col-span-1 relative'>
            <p className='bg-black m-4 text-white absolute left-0 bottom-0 z-10 p-2 font-mono text-sm'>TEXT.</p>
