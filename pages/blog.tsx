...
import { CardIcon, CardImg } from '../components/cards';
import { IconCodeSVG, IconDesignTechSVG, IconProcessSVG, IconWriteSVG, RectangeDotsSVG, RoundScribbleSVG } from '../components/svg';
